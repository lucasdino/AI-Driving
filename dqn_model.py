...
from dqn_modules import ReplayMemory
...
# N_ACTIONS is the number of possible actions from the game (n=4: Up, Down, Left, Right)
# N_OBSERVATIONS is the number of env vars being passed through. (n=1: 8-vision lines, rc_angle, angle_to_reward, dist_to_reward)
BATCH_SIZE = 128
GAMMA = 0.99
EPS_START = 0.9
EPS_END = 0.05
...
# steps_done is a dynamic variable to calculate step count
steps_done = 0
...
memory = ReplayMemory(MEMORY_FRAMES)
